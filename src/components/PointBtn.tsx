...
export function PointBtn({ side, onClick }: PointBtnProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.89 }}
      onClick={onClick}
      className={`relative flex min-h-[152px] flex-col items-center justify-center rounded-[24px] border px-5 py-5 shadow-[0_14px_34px_rgba(0,0,0,0.28)] ${
        isServer
    ...
    >
      ...
      <span className="text-[68px] font-black leading-none tracking-[-0.05em]">+1</span>
      <span className="mt-1.5 text-[28px] font-semibold tracking-[-0.04em]">
